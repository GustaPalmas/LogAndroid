...
public class ConMotoristaFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view = inflater.inflate(R.layout.fragment_con_motorista_list, container, false);
        ...
        try {
            ...
            if (jsonArray != null) {
                ...
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(new ConMotoristaRecyclerViewAdapter(this.motorista));
                }
                /*
                ...
                */
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(
                            new ConMotoristaRecyclerViewAdapter(this.motorista));
                }
            }else {
                Snackbar mensagem = Snackbar.make(view,
